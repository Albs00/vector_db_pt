...
class ClimaMasterRuntimeTests(unittest.TestCase):
    ...
    def assert_main_pts(self, query, expected):
        ...
        self.assertEqual(result["dataset_release"], "PT26_CLIMA_PROD_2_CAPACITY_MAPPING_FIX1")
        return result
    ...
    def test_release_contract(self):
        self.assertEqual(self.resolver.DATASET_VERSION, "PT26_CLIMA_PROD_2_CAPACITY_MAPPING_FIX1")
        self.assertEqual(self.resolver.EXPECTED_DATASET_VERSIONS, {
